...
namespace BinarySearchTreeApp
{
    public class BinaryTree
    {
        ...
        //O(Log n)
        public bool Insert(int data, int maxLevel)
        {
            if (root == null)
            {
            ...
            {
                return root.Insert(data, maxLevel, 1); // Truyền mức hiện tại là 1 (root)
            }
        }
        ...
        public string InOrderTraversal()
        {
            ...
            if (Root != null)
            {
                Root.InOrderTraversal(result, true);
            }
        ...
        public string PreOrderTraversal()
        {
            ...
            if (Root != null)
            {
                Root.PreOrderTraversal(result, true);
            }
            return result.ToString();
        }
        ...
        public string PostOrderTraversal()
        {
            ...
            if (Root != null)
            {
                Root.PostOrderTraversal(result, true);
            }
            return result.ToString();
        }
